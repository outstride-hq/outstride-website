...
export const capabilities: Capability[] = [
  ...
  {
    id: "hire-and-onboard-the-right-people",
    number: 8,
    emoji: "🧲",
    title: "Hire & Onboard the Right People",
    layerId: "company",
    groupId: "company-system",
    summary:
      "A serious hire deserves a serious process — start from what the organisation actually needs, select with evidence, and onboard like the outcome depends on it.",
    bullets: [
  ...
  },
  {
    ...
    toolIds: [
      "development-pipeline","ownership-map", "leadership-hats"],
    rhythmIds: [],
    order: 17,
  },
  {
